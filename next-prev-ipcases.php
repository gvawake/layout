...
// Only display for standard posts
	if ( 'ipcases' != get_post_type() ) {
		return;
		}

// Term 'taxonomy' => array( 'physics', 'chem', 'maths' ),
$term_tax = get_theme_mod( 'ocean_single_post_next_prev_taxonomy', array( 'copyright', 'patent', 'trademark' );
$term_tax = $term_tax ? $term_tax : array( 'copyright', 'patent', 'trademark' );
